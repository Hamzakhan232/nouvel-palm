...
export const metadata: Metadata = {
  title: "About",
  description: "Learn more about Nouvel Palm",
}
        ...
        <Layout>
          <LayoutColumn start={1} end={{ base: 13, lg: 7 }}>
            <h3 className="text-md max-lg:mb-6 md:text-2xl">
              At Nouvel Palm, we believe that a sofa is the heart of every
              home.
            </h3>
          </LayoutColumn> 
          <LayoutColumn start={{ base: 1, lg: 8 }} end={13}>
            <div className="md:text-md lg:mt-18">
              <p className="mb-5 lg:mb-9">
                Welcome to Nouvel Palm, where we believe that comfort and style
          ...
          <LayoutColumn start={{ base: 1, lg: 8 }} end={13}>
            <div className="md:text-md lg:mt-18">
              ...
              <p>
                ...
                memories. Thank you for choosing Nouvel Palm to be a part of
                your home!
              </p>
            </div>
          </LayoutColumn>
